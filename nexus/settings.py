...
MIDDLEWARE = [
    ...
    "core.middleware.CurrentAccountMiddleware",
...
# Key used to derive the Fernet key for encrypting stored credentials.
# Falls back to SECRET_KEY; set a dedicated stable value in production.
